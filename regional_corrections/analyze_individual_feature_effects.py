...
if not os.path.exists('{0}/{1}'.format(output_dir,output_prefix)): os.mkdir('{0}/{1}'.format(output_dir,output_prefix))
...
of = open('{0}/{1}/dnm01_10x_ft_logit_regularized_coef_z_3mer_context_flnk_1k-1M.txt'.format(output_dir,output_prefix),'w')
...
# copy file to gcs
os.system(
    'gsutil cp {0}/{1}/dnm01_10x_ft_logit_regularized_coef_z_3mer_context_flnk_1k-1M.txt {2}/{1}/'.format(output_dir,output_prefix,input_bucket)
)

# Select significant features
df = pd.read_csv('{0}/{1}/dnm01_10x_ft_logit_regularized_coef_z_3mer_context_flnk_1k-1M.txt'.format(output_dir,output_prefix),sep="\t")
...
# copy file to gcs
os.system(
    'gsutil cp {0}/{1}/dnm01_10x_ft_logit_regularized_coef_z_3mer_context_flnk_1k-1M.selected.txt {2}/{1}/'.format(output_dir,output_prefix,input_bucket)
)
